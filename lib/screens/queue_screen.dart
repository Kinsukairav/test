...
class QueueScreen extends ConsumerWidget {
  ...
  Widget _buildQueueList(BuildContext context, WidgetRef ref, List<Track> queue, int currentIndex, bool isPlaying) {
    return Column(
      children: [
        // Queue stats
        Container(
        ...
        Expanded(
          child: ReorderableListView.builder(
            ...
            onReorder: (oldIndex, newIndex) => _reorderQueue(ref, oldIndex, newIndex),
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      PopupMenuButton<String>(
                        onSelected: (value) => _handleTrackAction(context, ref, track, index, value),
                        itemBuilder: (context) => [
                          if (!isCurrent)
                            const PopupMenuItem(
                              value: 'play',
  ...
  void _handleTrackAction(BuildContext context, WidgetRef ref, Track track, int index, String action) {
    switch (action) {
      case 'play':
  ...
  void _removeFromQueue(WidgetRef ref, int index) {
    ...
    if (index < currentIndex) {
      ...
      updatedCurrentIndex = currentIndex >= updatedQueue.length ? updatedQueue.length - 1 : currentIndex;
    }
